...
<body>
	...
	<section>
		...
		<article>
			<?php
				$query4 = "SELECT u.name, u.username, ui.image, ui.bluetick FROM follow as f LEFT JOIN user as u ON f.follower = u.userid LEFT JOIN userinfo as ui ON f.follower = ui.userid WHERE f.follower = '$slamuserid'";

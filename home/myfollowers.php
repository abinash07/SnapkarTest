...
<body>
	...
	<div class="top">
		...
		<a id="snap" href="<?php echo $baseurl; ?>/index">My followers</a>
	...
	<section>
		...
		<article>
			<?php
				$query4 = "SELECT user.name, user.username, ui.image FROM follow INNER JOIN user ON follow.following = user.userid LEFT JOIN userinfo as ui ON follow.following = ui.userid WHERE follow.following = '$sbuserid';";
